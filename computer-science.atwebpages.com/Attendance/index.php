...
if (isset($_POST['login'])) {
	...
	try {
		...
		if ($row) {
			...
			$_SESSION['role'] = $userRole; // set the user's role in the session
			...
			switch ($userRole) {
				...
				case 'admin':
					...
					break;
				default:
					// Handle unexpected role behavious
					break;
			}
		} else {
		...
		<div class="content" style="background-color:none;">
			<div class="row">
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
					...
					<input type="submit" class="btn btn-success col-md-3 col-md-offset-7" style="border-radius:0%"
